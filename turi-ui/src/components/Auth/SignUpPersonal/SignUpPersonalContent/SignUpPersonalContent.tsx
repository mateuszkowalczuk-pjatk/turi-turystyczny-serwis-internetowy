                ...
                <PersonalPart
                    firstPanel={
                        <PersonalPanel
                            ...
                            firstInput={<PersonalInput text={t('signup-personal.name')} />}
                            secondInput={<PersonalInput text={t('signup-personal.surname')} />}
                        />
                    }
                    secondPanel={
                        <PersonalPanel
                            label={<PersonalLabel text={t('signup-personal.birthdate')} />}
                            firstInput={<PersonalInput text={t('signup-personal.day')} />}
                            secondInput={<PersonalInput text={t('signup-personal.month')} />}
                            thirdInput={<PersonalInput text={t('signup-personal.year')} />}
                        />
                    }
                    option={
                        <PersonalPanel
                ...
                <PersonalPart
                    firstPanel={
                        <PersonalPanel
                            ...
                            firstInput={<PersonalInput text={t('signup-personal.phone-number')} />}
                        />
                    }
                    secondPanel={
                        <PersonalPanel
                            label={<PersonalLabel text={t('signup-personal.address')} />}
                            firstInput={<PersonalInput text={t('signup-personal.country')} />}
                            secondInput={<PersonalInput text={t('signup-personal.city')} />}
                            thirdInput={<PersonalInput text={t('signup-personal.zipcode')} />}
                            fourthInput={<PersonalInput text={t('signup-personal.street')} />}
                            fifthInput={<PersonalInput text={t('signup-personal.building')} />}
                            sixthInput={<PersonalInput text={t('signup-personal.apartment')} />}
                        />
                    }
                    option={<SignUpPersonalButtons skipOnClick={handleSkipClick} />}
                />
            </div>
