...
public class JwtFilter extends OncePerRequestFilter
{
                                    ...
                                    @NotNull final FilterChain filterChain) throws ServletException, IOException
    {
        ...
        if (path.startsWith("/api/auth/register")
                ...
                || path.startsWith("/api/image/getByAccountId")
                || path.startsWith("/api/image/getAllByTouristicPlaceId")
                || path.startsWith("/api/image/getAllByStayId")
                || path.startsWith("/api/image/getAllByAttractionId")
